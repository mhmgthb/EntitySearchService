...
public class CommonConstants {
    ...
    public static final Map<String,String> entityNameIndexMap = Map.of(
            "Contracts","qiwa-contracts",
            "Establishments", "establishment-profile-info",
            "Labour", "qiwa-laborer-info",
            "Qualifications","qiwa-employee-qualifications",
            "Training","qiwa-training-indicators",
            "Occupation","qiwa-occupation"
            );
    ...
    public  static  final  String BETWEEN_VALUE_INVALID = "Upper and lower limits must be separated with space";
